...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 2
    actual = count_positive_sines([9, 10, 11, 12, 13 ])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 18
    actual = sum_first_n([22, -4, 16, 13], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 31
    actual = sum_first_n([23, -7, 15, -3, 22], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
